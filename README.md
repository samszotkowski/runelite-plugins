...
<img style="float:right" alt="plugin panel demo" src="https://github.com/samszotkowski/runelite-plugins/blob/slayer-history/readme-img0.png" />
...
## Changelog
1.2 - Streak # after completing each task now shows up as a number in the bottom right. Previous tasks won't have any data, but if you want numbers to display for old entries you can edit the numbers in yourself.

To do this, edit the lines in `tasks.log` so they look like `{...,"taskStreak":1000}`
